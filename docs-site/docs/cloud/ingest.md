...
The wire protocol between agents (collector, WordPress plugin, third-party)
and the console. The full specification (`spec/ingest-v1.md`) is reproduced
verbatim below.
...
the WordPress plugin and any third-party agent. Consoles: PHPRay Cloud (`https://app.phpray.dev`)
